...
export function ExperienceTimeline({ experiences }: ExperienceTimelineProps) {
  ...
  return (
    <div className="relative max-w-3xl mx-auto">
      {/* Timeline line */}
      <div className="absolute left-0 w-0.5 h-full bg-gradient-to-b from-primary/80 via-primary/50 to-primary/20 md:left-1/2 md:-translate-x-1/2" />
              ...
              <div className={`w-full md:w-1/2 ${index % 2 === 0 ? "md:pr-12" : "md:pl-12"}`}>
                <Card className="overflow-hidden border-border/50 shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <CardContent className="p-6">
                    ...
                    <h4 className="mb-2 text-lg font-medium text-primary">{exp.company}</h4>
